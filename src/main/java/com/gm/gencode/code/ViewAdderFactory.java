...
public class ViewAdderFactory implements IBuildCodeFactory {
	...
	private String tplName = "add.ftl";
	...
	public static ViewAdderFactory buildViewAdderFactory(Class<?> cl) {
		ViewAdderFactory idaoFactory = new ViewAdderFactory();
		idaoFactory.cl = cl;
		return idaoFactory;
	}
