...
public class ViewManagerFactory implements IBuildCodeFactory {
	...
	private String tplName = "list.ftl";
	...
	public static ViewManagerFactory buildViewManagerFactory(Class<?> cl) {
		ViewManagerFactory idaoFactory = new ViewManagerFactory();
		idaoFactory.cl = cl;
		return idaoFactory;
	}
